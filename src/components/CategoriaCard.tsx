...
const getCategoryColor = (categoria: string): string => {
  const colors: Record<string, string> = {
    ...
    "Texto para Vídeo": "bg-gradient-to-r from-purple-600 to-violet-600",
    "Modelos 3D": "bg-gradient-to-r from-indigo-600 to-purple-600",
    ...
    "Gerador de Histórias": "bg-gradient-to-r from-amber-600 to-orange-600",
    ...
    "Transcrição": "bg-gradient-to-r from-cyan-600 to-blue-600",
    ...
    "Agentes de IA": "bg-gradient-to-r from-cyan-500 to-blue-600",
    ...
    "Automação": "bg-gradient-to-r from-purple-500 to-indigo-600",
    ...
    // Dados e Análise
    "Dados & Analytics": "bg-gradient-to-r from-purple-500 to-pink-500",
    ...
    "Pesquisa & Ciência": "bg-gradient-to-r from-indigo-500 to-purple-500",
    
    // Especialidades
    "Saúde": "bg-gradient-to-r from-red-400 to-rose-400",
    "Assistentes Jurídicos": "bg-gradient-to-r from-slate-600 to-gray-600",
    "Moda": "bg-gradient-to-r from-fuchsia-400 to-pink-500",
    "Viagens": "bg-gradient-to-r from-sky-400 to-cyan-400",
    "Tecnologia Assistiva": "bg-gradient-to-r from-emerald-600 to-teal-600",
    "Tradução": "bg-gradient-to-r from-blue-400 to-indigo-400",
  };
...
const CategoriaCard = ({ nome, icone, ferramentas, totalFerramentas }: CategoriaCardProps) => {
  ...
  return (
    <div className="relative bg-card border border-border/50 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 shadow-md">
      {/* Cabeçalho da Categoria */}
      <div className="flex items-center gap-3 px-4 py-2.5">
        <div className={`flex items-center justify-center w-8 h-8 rounded-lg ${colorClasses} shadow-sm`}>
      ...
      {/* Linha gradiente separadora */}
      <div className={`h-0.5 ${colorClasses}`} />
